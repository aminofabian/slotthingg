      ...
      <div className="w-full px-6">
        <div className="max-w-[1440px] mx-auto">
          <div className="flex justify-between items-center mb-6">
            ...
            <button className="bg-[#00ffff] hover:bg-[#7ffdfd] text-[#003333] font-bold py-2.5 px-5 rounded-lg transition-all duration-300 flex items-center gap-2 shadow-lg hover:shadow-[#00ffff]/20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 lg:gap-8 pb-8">
            {games.map((game) => (
              <div key={game.id} 
