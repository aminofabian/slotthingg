      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-[#002222] w-full max-w-2xl rounded-2xl shadow-xl border border-[#00ffff]/10 overflow-hidden"
          >
            {/* Chat Header */}
            <div className="p-4 border-b border-[#00ffff]/10 flex items-center justify-between bg-black/20">
              <div className="flex items-center gap-3">
                <div className="p-2 rounded-lg bg-[#00ffff]/10">
                  <IoChatbubbleEllipses className="w-6 h-6 text-[#00ffff]" />
                </div>
                <div>
                  <h3 className="text-lg font-medium text-white">Support Chat</h3>
                  <p className="text-sm text-[#00ffff]/70">We're here to help</p>
                </div>
              </div>
              <button
                onClick={onClose}
            ...
            <div 
              ...
              className="h-[500px] overflow-y-auto p-4 space-y-4 bg-gradient-to-b from-black/20 to-transparent"
            >
              {isLoading ? (
                ...
                messages.map((msg) => (
                  ...
                  >
                    {msg.type === 'message' ? (
                      ...
                      <div className="text-[0.7rem] text-white/40 py-2">
                        {msg.message}
                      </div>
                    )}
                  </div>
            ...
            {/* Chat Input */}
            <form onSubmit={handleSendMessage} className="p-4 border-t border-[#00ffff]/10 bg-black/20">
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="flex-1 bg-white/5 border border-[#00ffff]/20 rounded-xl px-4 py-3
                ...
                <button
                  ...
                  className="p-3 rounded-xl bg-[#00ffff]/10 text-[#00ffff] 
